...
//Sensorkonfiguration
//----------------------------------------------------------------
#define Anzahl_Sensoren_DHT     1 // Mögliche Werte: '0','1','2'  --- Nr 1+2 ---- (Temperatur + Luftfeuchte)
...
const long Taragewicht[4] = { 138429,  10,  10,  10 }; // Hier ist der Wert aus der Kalibrierung einzutragen
const float Skalierung[4] = { 27615.58, 1.0, 1.0, 1.0 }; // Hier ist der Wert aus der Kalibrierung einzutragen
...
const char  APN[] PROGMEM = {"webapn.at"};//("internet.t-mobile");("web.vodafone.de");
